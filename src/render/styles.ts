...
.ide {
  ...
  grid-template-rows: 74px 1fr 54px;
  background:
...
.window-controls { width: 62px; display: flex; align-items: center; justify-content: center; gap: 7px; border-right: 1px solid var(--border-soft); }
...
.side-icon { width: 38px; height: 38px; border-radius: 8px; display: grid; place-items: center; color: #737e8e; font: 700 17px var(--mono); border: 1px solid transparent; }
.side-icon.active { color: #9ac3ff; background: rgba(13,110,253,.11); border-color: rgba(13,110,253,.35); }
.side-divider { width: 30px; height: 1px; background: #333a44; margin: 2px 0; }
...
.editor {
  ...
  overflow: hidden;
  background:
    linear-gradient(90deg, transparent 0 48px, rgba(255,255,255,.025) 48px 49px, transparent 49px),
    var(--bg);
}
.line-numbers { position: absolute; left: 0; top: 22px; width: 46px; color: #59616e; font: 17px/42px var(--mono); text-align: right; padding-right: 12px; user-select: none; }
.line-numbers span { display: block; }

.card {
  position: absolute;
  inset: 0 0 0 48px;
  padding: 48px 52px 42px 44px;
  display: flex;
  flex-direction: column;
  gap: 30px;
}
.card-kicker { display: flex; align-items: center; gap: 18px; min-height: 62px; }
.card-number { width: 66px; height: 66px; flex: 0 0 auto; display: grid; place-items: center; border-radius: 50%; background: linear-gradient(145deg, #1680ff, #0959d8); color: white; font: 800 24px var(--mono); box-shadow: 0 0 0 6px rgba(13,110,253,.09), 0 0 28px rgba(13,110,253,.28); }
.section-label { color: #b8c2cf; letter-spacing: .14em; font: 800 19px var(--mono); text-transform: uppercase; }

h1, h2, h3, p { margin: 0; }
.title-xl { font-size: 82px; line-height: 1.04; letter-spacing: -.045em; font-weight: 850; max-width: 850px; }
.title-lg { font-size: 60px; line-height: 1.08; letter-spacing: -.035em; font-weight: 820; }
.title-md { font-size: 36px; line-height: 1.2; font-weight: 780; }
.body-lg { font-size: 32px; line-height: 1.42; color: #d6dbe4; }
.body-md { font-size: 27px; line-height: 1.45; color: #c9d0db; }
.body-sm { font-size: 22px; line-height: 1.42; color: #b4bdca; }
.muted { color: var(--muted); }
.mono { font-family: var(--mono); }

.hero-token { font: 850 78px/1.08 var(--mono); color: #d2c4ff; padding: 34px 36px; border-radius: 18px; border: 1px solid rgba(168,85,247,.35); background: linear-gradient(135deg, rgba(168,85,247,.13), rgba(13,110,253,.08)); box-shadow: inset 0 1px 0 rgba(255,255,255,.04), 0 18px 50px rgba(0,0,0,.22); overflow-wrap: anywhere; }
.hook-panel { border-left: 6px solid var(--blue); background: linear-gradient(90deg, rgba(13,110,253,.13), rgba(13,110,253,.055)); border-radius: 14px; padding: 30px 32px; box-shadow: 0 18px 44px rgba(0,0,0,.18); }
.caption { color: #9eb7d9; font: 650 22px/1.42 var(--mono); }

.panel { background: linear-gradient(180deg, rgba(42,49,59,.98), rgba(31,36,43,.98)); border: 1px solid var(--border); border-radius: 16px; box-shadow: 0 22px 48px rgba(0,0,0,.22), inset 0 1px 0 rgba(255,255,255,.025); }
.panel-pad { padding: 32px 34px; }
.panel-title { font: 850 18px var(--mono); letter-spacing: .12em; text-transform: uppercase; margin-bottom: 16px; }
...
.flow-box { padding: 32px; }
.flow-label { font: 850 17px var(--mono); letter-spacing: .12em; text-transform: uppercase; margin-bottom: 24px; }
.flow-label.good { color: #70dc93; }
.flow-label.warn { color: #f7bc56; }
.flow-label.info { color: #7bb0ff; }
.flow { display: flex; align-items: stretch; gap: 12px; width: 100%; }
.flow-step { flex: 1 1 0; min-width: 0; min-height: 142px; padding: 20px 12px; border: 1px solid #3b4654; border-radius: 12px; background: #20252c; display: flex; align-items: center; justify-content: center; text-align: center; font: 750 19px/1.25 var(--mono); color: #d8e0ea; overflow-wrap: anywhere; }
.flow-arrow { flex: 0 0 28px; display: grid; place-items: center; color: #647185; font: 800 28px var(--mono); }
...
.code-lines { padding: 26px 0 28px; font: 23px/1.6 var(--mono); }
...
.micro-example {
  border: 1px solid rgba(83,216,251,.34);
  border-left: 5px solid var(--cyan);
  border-radius: 16px;
  padding: 28px 32px;
  background: linear-gradient(135deg, rgba(83,216,251,.09), rgba(13,110,253,.055));
  box-shadow: 0 20px 48px rgba(0,0,0,.18);
}
.micro-example .panel-title { color: #72dcf7; }
.micro-example-text {
  color: #d9e7f8;
  font: 750 22px/1.5 var(--mono);
...
.key-outcome {
  ...
  border-radius: 16px;
  padding: 30px 34px;
  background: linear-gradient(135deg, rgba(34,197,94,.10), rgba(34,197,94,.035));
  box-shadow: 0 20px 48px rgba(0,0,0,.18);
}
.key-outcome .panel-title { color: #72dd96; }
...
.debug-clue {
  ...
  border-radius: 16px;
  padding: 28px 32px;
  background: linear-gradient(135deg, rgba(245,158,11,.10), rgba(245,158,11,.035));
  box-shadow: 0 20px 48px rgba(0,0,0,.18);
}
.debug-clue .panel-title { color: #f8bd59; }
...
.interviewer-testing {
  ...
  border-radius: 16px;
  padding: 28px 32px;
  background: linear-gradient(135deg, rgba(168,85,247,.11), rgba(13,110,253,.035));
  box-shadow: 0 20px 48px rgba(0,0,0,.18);
}
.interviewer-testing .panel-title { color: #c79bff; }

.panel.good .flow-step {
  border-color: rgba(34,197,94,.30);
  background: linear-gradient(180deg, rgba(34,197,94,.075), rgba(32,37,44,.96));
}
.panel.warn .flow-step {
  border-color: rgba(245,158,11,.30);
  background: linear-gradient(180deg, rgba(245,158,11,.07), rgba(32,37,44,.96));
}
.panel.good .flow-step:last-child {
  color: #96efae;
  border-color: rgba(34,197,94,.6);
  box-shadow: inset 0 0 0 1px rgba(34,197,94,.12), 0 0 24px rgba(34,197,94,.09);
}
.panel.warn .flow-step:last-child {
  color: #ffd18a;
  border-color: rgba(245,158,11,.62);
  box-shadow: inset 0 0 0 1px rgba(245,158,11,.12), 0 0 24px rgba(245,158,11,.08);
}

.hook-stack, .mental-stack, .code-stack, .production-stack, .interview-stack {
  max-width: 100%;
}
...
.statusbar { grid-column: 1 / 3; grid-row: 3; display: grid; grid-template-columns: 62px 1fr auto; align-items: center; background: #171a1f; border-top: 1px solid var(--border); color: #727c89; font: 15px var(--mono); }
